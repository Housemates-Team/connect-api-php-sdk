...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'http://localhost:8060';
    ...
    public static function getHostString(array $hostsSettings, $hostIndex, array $variables = null)
    {
        ...
        foreach ($host["variables"] ?? [] as $name => $variable) {
            if (array_key_exists($name, $variables)) { // check to see if it's in the variables provided by the user
                if (!isset($variable['enum_values']) || in_array($variables[$name], $variable["enum_values"],
                        true)) { // check to see if the value is in the enum
                    $url = str_replace("{".$name."}", $variables[$name], $url);
                } else {
                    throw new \InvalidArgumentException("The variable `$name` in the host URL has invalid value ".$variables[$name].". Must be ".join(',',
    ...
    public function getHostSettings()
    {
        return [
            ...
            [
                "url" => "https://connect.housemates.io",
                "description" => "Production server",
            ],
            [
                "url" => "https://dev.connect.housemates.io",
