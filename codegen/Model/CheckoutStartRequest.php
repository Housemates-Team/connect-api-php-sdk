...
class CheckoutStartRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'checkoutStart_request';
    ...
    /**
     * Gets booking_period_id
     *
     * @return string
     */
    public function getBookingPeriodId()
    {
        return $this->container['booking_period_id'];
    }

    /**
     * Sets booking_period_id
     *
     * @param  string  $booking_period_id  booking_period_id
     *
     * @return self
     */
