<?php
/**
 * UnauthenticatedErrorResponseAllOfDataMessages
 *
 * PHP version 7.4
 *
 * @category Class
...
class UnauthenticatedErrorResponseAllOfDataMessages implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'UnauthenticatedErrorResponse_allOf_data_messages';
    ...
    {
        $this->setIfExists('error_key', $data ?? [], null);
    }
     ...
     * Sets error_key
     *
     * @param  string[]|null  $error_key  error_key
     *
     * @return self
     */
