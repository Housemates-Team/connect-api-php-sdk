<?php
/**
 * UnauthenticatedErrorResponseAllOf
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * UnauthenticatedErrorResponseAllOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UnauthenticatedErrorResponseAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'UnauthenticatedErrorResponse_allOf';
    ...
    protected static $openAPITypes = [
        'data' => '\OpenAPI\Client\Model\UnauthenticatedErrorResponseAllOfData'
    ];
