...
openapi-generator-cli generate --enable-post-process-file -i ~/Code/housemates-connect-api/housemates-connect.yaml -g php -o ./openapi_generated_connect --global-property skipFormModel=false
